    ...
    return (
      <BrowserRouter>
        <div style={{'marginTop': '5px'}}>
          ...
          <div>
            <Switch>
              <Route path="/eat" render={() => <EatView newTrip={this.props.newTrip} eat={ this.props.eat } />} />
              <Route path="/party" render={() => <PartyView newTrip={this.props.newTrip} party={ this.props.party } />} />
              <Route path="/sleep" render={() => <SleepView newTrip={this.props.newTrip} sleep={ this.props.sleep } />} />
              <Route path="/explore" render={() => <ExploreView newTrip={this.props.newTrip} explore={ this.props.explore } />} />
              <Route path="/trips" render={() => <ItineraryView itineraries={ this.props.itineraries } />} />
            </Switch>
          </div>
        </div>
      </BrowserRouter>
